...
public class TuringMachine/*@bgen(jjtree)*/implements TuringMachineTreeConstants, TuringMachineConstants {/*@bgen(jjtree)*/
  ...
  public static void main(String[] args) throws ParseException, FileNotFoundException, UnsupportedEncodingException, IOException, InterruptedException {

    if(args.length > 2) {
      System.out.println("USAGE FOR COMPILER: java TuringMachine inputfile [-d]");
      System.exit(1);
    ...
    Runtime.getRuntime().exec("javac output.java");
    Thread.sleep(4000);
    Runtime.getRuntime().exec("jar cfe YourTuringMachine.jar output output.class output$1Card.class");
  }
